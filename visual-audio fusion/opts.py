...
parser.add_argument('--dataset', type=str, help='choose a dataset',default='/Users/wzr/Downloads/test_for_mininet/video')
parser.add_argument('--domain', type=str, help='choose a domain',default='')
...
parser.add_argument('--test_path', type=str,default='/Users/wzr/Downloads/test_for_mininet/test_all')
